...
Dutch language learning reference content — markdown and JSON — served as raw files to the [opmaat](https://github.com/alitskevich/codespace/tree/main/apps/opmaat) app via the GitHub trees API.
...
- Tree endpoint: `https://api.github.com/repos/alitskevich/dutch-opmaat-docs/git/trees/main?recursive=1`
- Raw file base: `https://raw.githubusercontent.com/alitskevich/dutch-opmaat-docs/main`
