...
The same modal verb often covers several modalities, and each modality can usually
...
|---|----------|-----------------|------------------------|
| 1 | Ability | **kunnen** | in staat zijn om te, weten te |
| 2 | Possibility | **kunnen** | misschien, wellicht, het kan (zijn) dat |
| 3 | Permission | **mogen** | toestaan, het is toegestaan om te |
| 4 | Prohibition | **mogen** + niet | verboden zijn, niet toegestaan |
| 5 | Obligation / Necessity | **moeten** | dienen te, verplicht zijn om te, het is nodig |
| 6 | Absence of necessity | **hoeven** + niet/geen | niet nodig zijn |
| 7 | Advice / Recommendation | **moeten**, **zouden** + moeten | het beste, je kunt beter |
| 8 | Desire / Wish | **willen** | graag (willen), zin hebben in, lust hebben |
| 9 | Intention / Plan | **gaan**, **zullen** | van plan zijn, voornemens zijn |
| 10 | Future / Prediction | **zullen**, **gaan**, present + tijdsbepaling | morgen, straks, volgende week |
| 11 | Offer / Proposal | **zullen** | wil je…, laten we…, zal ik… |
...
- We **zullen** dat regelen. (We will arrange that.)
...
schedules, and near-future events.
...
- **Zullen** we **gaan**? (Shall we go? — polite suggestion, extremely common)

The "Shall we…?" form is one of the most useful Dutch sentence patterns:
...
| **Ik wil graag …** | I would like to … | **Ik wil graag** Nederlands leren. |
...
- Ik **kan** dat **lezen**. (I can read that.)
- Zij **moet** nu **vertrekken**. (She must leave now.)

**Perfect tense** — the past participle of the modal is replaced by an infinitive
(this is the *Infinitivus pro Participio*, IPP):

- Ik **heb** dat **kunnen lezen**. (I was able to read that.)  *not* `gekund`
- Zij **heeft** **moeten vertrekken**. (She had to leave.)  *not* `gemoeten`

**Exception — *zullen*:**

- Ik **zal** dat **gelezen hebben**. (I will have read that.)
