...
speaker reports a claim rather than weighing how likely it is.
...
Contrast with deduction: `Dat **moet** een vergissing zijn` (§12) is the speaker's own
conclusion; `Die film **moet** goed zijn` reports others' opinion. Context and topic
disambiguate the two uses of `moeten`.
